...
// Define this to set a custom name for your generic Mendel,
 #define CUSTOM_MENDEL_NAME "P-1 <3"
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    #define RIGHT_PROBE_BED_POSITION 170 // default 170
    ...
    // is used to esimate the plane of the print bed
      ...
      #define ABL_PROBE_PT_3_X 130 // default 170
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -1.66
...
#define HOMING_FEEDRATE {50*60, 50*60, 4*20, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,400,95}  //M5 0.8mm/3200 default steps per unit for Ultimaker
